...
class NextAddToCart extends StatefulWidget {
  const NextAddToCart({Key? key}) : super(key: key);

  @override
  State<NextAddToCart> createState() => _NextAddToCartState();
}

class _NextAddToCartState extends State<NextAddToCart> {
