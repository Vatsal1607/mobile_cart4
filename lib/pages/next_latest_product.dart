...
class NextLatestProduct extends StatefulWidget {
  const NextLatestProduct({Key? key}) : super(key: key);

  @override
  State<NextLatestProduct> createState() => _NextLatestProductState();
}

class _NextLatestProductState extends State<NextLatestProduct> {
